package com.example.bingo.navigation
...
import com.example.bingo.data.repository.AuthRepository
import com.example.bingo.ui.features.auth.AuthSelectionScreen
import com.example.bingo.ui.features.auth.LoginScreen
import com.example.bingo.ui.features.auth.LoginViewModel
import com.example.bingo.ui.features.auth.register.RegisterScreen
import com.example.bingo.ui.features.auth.register.RegisterViewModel
import com.example.bingo.ui.features.onboarding.OnboardingScreen
import com.example.bingo.ui.features.splash.SplashScreen
import com.example.bingo.ui.features.splash.LoadingScreen
import com.example.bingo.ui.features.home.HomeScreen
...
fun AppNavigation() {
    ...
    NavHost(
        ...
        composable("splash") { backStackEntry ->
            val splashViewModel: com.example.bingo.ui.features.splash.SplashViewModel = hiltViewModel()
            SplashScreen(
        ...
        composable("onboarding") { backStackEntry ->
            val onboardingViewModel: com.example.bingo.ui.features.onboarding.OnboardingViewModel = hiltViewModel()
            OnboardingScreen(
        ...
        composable(
            ...
            val homeViewModel: com.example.bingo.ui.features.home.HomeViewModel = hiltViewModel()
        ...
        composable("mission") { backStackEntry ->
            com.example.bingo.ui.features.mission.MissionScreen(
        ...
        composable(
            ...
            val homeViewModel: com.example.bingo.ui.features.home.HomeViewModel = hiltViewModel(homeEntry)
            val uiState by homeViewModel.uiState.collectAsState()

            val activeMission = uiState.activeMissions.firstOrNull()
            val targetProgress = activeMission?.targetProgress ?: 5

            com.example.bingo.ui.features.mission.MissionDetailScreen(
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
                    }
        ...
        composable(
            ...
            com.example.bingo.ui.features.mission.MissionRewardScreen(
                onBackClick = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
                    }
        ...
        composable(
            ...
            com.example.bingo.ui.features.profile.EditProfileScreen(
        ...
        composable(
            ...
            com.example.bingo.ui.features.story.StoryDetailScreen(
                episodeId = episodeId,
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
        ...
        composable(
            ...
            com.example.bingo.ui.features.quiz.QuizScreen(
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
                    }
        ...
        composable(
            ...
            com.example.bingo.ui.features.quiz.QuizEpisodeScreen(
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
                    }
        ...
        composable(
            ...
            val episodeId = backStackEntry.arguments?.getString("episodeId") ?: ""
            com.example.bingo.ui.features.quiz.QuizPrepScreen(
                episodeId = episodeId,
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
        ...
        composable(
            ...
            val episodeId = backStackEntry.arguments?.getString("episodeId") ?: ""
            com.example.bingo.ui.features.quiz.QuizQuestionScreen(
                episodeId = episodeId,
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
        ...
        composable(
            ...
            com.example.bingo.ui.features.quiz.QuizBreakScreen(
                onNavigateBack = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.popBackStack()
                    }
        ...
        composable(
            ...
            com.example.bingo.ui.features.quiz.QuizCompleteScreen(
                episodeId = episodeId,
        ...
        composable(
            ...
            val episodeId = backStackEntry.arguments?.getString("episodeId") ?: ""
            com.example.bingo.ui.features.quiz.QuizExplanationScreen(
                episodeId = episodeId,
                onNavigateHome = {
                    if (backStackEntry.lifecycle.currentState == Lifecycle.State.RESUMED) {
                        navController.navigate("home") {
        ...
        composable(
            ...
            val homeViewModel: com.example.bingo.ui.features.home.HomeViewModel = hiltViewModel(homeEntry)
            val diaryViewModel: com.example.bingo.ui.features.diary.DiaryViewModel = hiltViewModel()
            val uiState by homeViewModel.uiState.collectAsState()

            com.example.bingo.ui.features.diary.DiaryScreen(
