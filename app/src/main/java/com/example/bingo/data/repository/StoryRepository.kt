...
import com.example.bingo.data.model.StoryChapterDto
import com.example.bingo.data.model.StoryEpisodeDto
import com.example.bingo.data.model.UserStoryProgressDto
...
class StoryRepository @Inject constructor(
    ...
    suspend fun markEpisodeCompleted(episodeId: String): Result<com.example.bingo.data.model.StoryRewardResponse?> {
        return try {
            val userId = getCurrentUserId() ?: throw Exception("User not logged in")
            ...
            var rewardData: com.example.bingo.data.model.StoryRewardResponse? = null
            try {
                val dbResult = supabase.postgrest.rpc("log_story_history", params)
                rewardData = dbResult.decodeAs<com.example.bingo.data.model.StoryRewardResponse>()
            } catch (e: Exception) {
