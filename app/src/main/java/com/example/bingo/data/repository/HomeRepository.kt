...
import com.example.bingo.data.model.ActiveMission
import com.example.bingo.data.model.DailyMissionTracker
import com.example.bingo.data.model.DailyMissionTrackerInsert
import com.example.bingo.data.model.EduArticle
import com.example.bingo.data.model.LeaderboardUser
import com.example.bingo.data.model.MasterTask
import com.example.bingo.data.model.PointShopItem
import com.example.bingo.data.model.ShopCategory
import com.example.bingo.data.model.UserProfile
import com.example.bingo.data.model.UserInventoryItem
import com.example.bingo.data.model.UserTask
import com.example.bingo.data.model.WasteCategory
import com.example.bingo.data.model.WasteEntryResponse
import com.example.bingo.data.model.quiz.QuizChapter
import com.example.bingo.data.model.quiz.QuizEpisode
import com.example.bingo.data.model.quiz.QuizQuestionDto
import com.example.bingo.data.model.quiz.QuizResultResponse
import com.example.bingo.data.model.quiz.UserChapterProgress
import com.example.bingo.data.model.quiz.UserQuizProgress
...
class HomeRepository @Inject constructor(
    ...
    suspend fun getDailyHistory(dateStr: String): Result<com.example.bingo.data.model.DailyHistory> {
        return try {
            val userId = getCurrentUserId() ?: throw Exception("User not authenticated")
            ...
            Result.success(com.example.bingo.data.model.DailyHistory(
                date = dateStr, 
