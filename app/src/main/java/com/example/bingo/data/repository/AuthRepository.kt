    ...
    suspend fun recordTrashDisposal(quantity: Int, category: String = "organic"): Result<Int> {
        return try {
            ...
            val existingEntries = supabase.postgrest["daily_missions"]
                ...
                }.decodeList<com.example.bingo.data.model.DailyMissionEntry>()

            val missionRow: com.example.bingo.data.model.DailyMissionEntry
            ...
            if (existingEntries.isNotEmpty()) {
                ...
                missionRow = supabase.postgrest["daily_missions"]
                    .insert(buildJsonObject {
                        ...
                        select()
                    }.decodeSingle<com.example.bingo.data.model.DailyMissionEntry>()
            }
