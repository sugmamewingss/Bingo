...
fun SelectedChapterCard(
    chapter: com.example.bingo.data.model.quiz.QuizChapter,
    episodesCount: Int,
    accumulativeXp: Int,
...
fun EpisodeListContainer(
    episodes: List<com.example.bingo.data.model.quiz.QuizEpisode>,
    progressList: List<com.example.bingo.data.model.quiz.UserQuizProgress>,
    onNavigateToPrep: (String) -> Unit = {}
) {
    Surface(
