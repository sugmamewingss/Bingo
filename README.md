...
| No  | Nama                   | NIM             |
| :-: | ---------------------- | --------------- |
|  1  | Angga Prima Ramadhan   | 245150300111013 |
|  2  | Alfi Perdiansyah Putra | 245150701111028 |
|  3  | Riesya Nadiha Devvy    | 245150700111045 |
|  4  | Rakapaksi Satrya Putra | 245150701111034 |
...
- **Loading Screen** - Setelah registrasi, ditampilkan layar loading edukatif dengan _fun fact_ lingkungan acak dan animasi pulsing.
...
| ------- | ------------------ | ------------------------------------------------------------------------ |
| 1       | **Journey**        | Landing page: profil, progress misi, tombol _"Mulai Kumpulkan!"_         |
| 2       | **Intro**          | Motivasi dari Gobi: _"Ayo ceritakan aksi barumu!"_                       |
...
- **Locking System** - Episode harus dibaca berurutan; belum tersedia ditandai _"COMING SOON"_.
...
├── BingoApplication.kt             # @HiltAndroidApp Application class
│
├── data/
│   ├── local/
...
1. **Clone repository**
   ...
   ```bash
   git clone https://github.com/sugmamewingss/Bingo.git
   cd Bingo
   ```
